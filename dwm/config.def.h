...
static char selbgcolor[]                 = "#bb83f7";
static char selbordercolor[]             = "#bb83f7";
static char selfloatcolor[]              = "#bb83f7";
...
static char titleselbgcolor[]            = "#bb83f7";
static char titleselbordercolor[]        = "#bb83f7";
static char titleselfloatcolor[]         = "#bb83f7";
...
static char tagsselbgcolor[]             = "#bb83f7";
static char tagsselbordercolor[]         = "#bb83f7";
static char tagsselfloatcolor[]          = "#bb83f7";
...
static const Key keys[] = {
	...
	#endif // INPLACEROTATE_PATCH #if PUSH_PATCH || PUSH_NO_MASTER_PATCH
  ...
  { MODKEY,  XK_F7, spawn, CMD("virt-manager") },
  { MODKEY,  XK_x, spawn, CMD("$HOME/.config/dmenu/scripts/powermenu.sh") },
  { MODKEY|ShiftMask, XK_x, spawn, CMD("$HOME/.config/dmenu/scripts/app-menu.sh") },
  { MODKEY, XK_F1, spawn, CMD("setxkbmap us")},
  { MODKEY, XK_F2, spawn, CMD("setxkbmap gr")},
